...
// Necessario chamar o exigirLogin para que esta página tenha acesso
...
if (isset($_POST["atualizar"])) {
	try {
		...
		/* Avaliando a senha
		Se o campo de senha estiver vazio, entao vamos manter a mesma senha já existente no banco. Caso contrário, vamos repassar a senha digitada para a verificação. */

...
Sessão (SESSION) é uma funcionalidade usada para o controle de acesso e outras informações que sejam importantes enquanto o navegador estiver aberto com o site.

Exemplo: áreas administrativas, painel de controle/dashboard, área do cliente, área do aluno etc.
